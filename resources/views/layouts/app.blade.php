...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            ...
            <li class="nav-group">
                <a class="nav-link nav-group-toggle" href="{{ route('patients.index') }}">
                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="var(--ci-primary-color, currentcolor)"
            ...
            <li class="nav-group">
                ...
                <ul class="nav-group-items compact">
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/autocomplete/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Autocomplete
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path fill="var(--ci-primary-color, currentcolor)"
                                    d="M400 464H48V104h192V72H16v424h416V272h-32z" class="ci-primary" />
                                <path fill="var(--ci-primary-color, currentcolor)"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/date-picker/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Date Picker
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/date-range-picker/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Date Range Picker
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/multi-select/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Multi Select
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/password-input/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Password Input
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/range-slider/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Range Slider
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/time-picker/"
                            target="_blank">
                            <span class="nav-icon"><span class="nav-icon-bullet"></span></span>
                            Time Picker
                            <svg class="icon icon-sm ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <a class="dropdown-item" href="#">
                                <svg class="icon me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path fill="var(--ci-primary-color, currentcolor)"
                                        ...
                                        class="ci-primary" />
                                    <path fill="var(--ci-primary-color, currentcolor)"
                                        d="M88 312h64v32H88zm96 0h64v32h-64z" class="ci-primary" />
                                </svg>
                                Payments
                            </a>
                            <a class="dropdown-item" href="#">
